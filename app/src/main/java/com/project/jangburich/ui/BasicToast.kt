...
import com.project.jangburich.MainUtil.toPx
import com.project.jangburich.R
import com.project.jangburich.databinding.ToastBasicBinding
import kotlin.run
...
object BasicToast {
    fun showBasicToast(context: Context, message: String, icon: Int, anchorView: View) {
        ...
        anchorView.post {
            ...
            val yOffset = -(anchorView.height + popupHeight + 20.toPx())
